...
class _FinancePageState extends State<FinancePage>
  ...
  // ── 新增/编辑 ──
  Future<void> _showDialog({TransactionEntry? existing}) async {
    ...
    final amountCtl = TextEditingController(text: existing?.amount.toStringAsFixed(2) ?? '');
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: cats.map((c) {
                        ...
                        return ChoiceChip(
                          avatar: Icon(c['icon'] as IconData, size: 14),
                          label: Text(c['label'] as String, style: const TextStyle(fontSize: 12)),
                          selected: sel,
                          selectedColor: type == 'expense' ? Colors.orange.shade100 : Colors.teal.shade100,
                    ...
                    if (type == 'expense') ...[
                      ...
                      const Text('没有好坏之分，只是记录此刻的感觉', style: TextStyle(fontSize: 11, color: Colors.black54)),
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(fontSize: 14, fontWeight: sel ? FontWeight.bold : FontWeight.normal),
                              ),
                            ),
                          );
                        }).toList(),
    ...
    await showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Text('这只是一个参考，不会给你任何压力', style: TextStyle(fontSize: 12, color: Colors.black54)),
            const SizedBox(height: 12),
            TextField(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('了解自己的消费感受，没有好坏之分', style: TextStyle(fontSize: 11, color: Colors.black54)),
              const SizedBox(height: 10),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('觉察到后悔本身就是进步，不需要自责', style: TextStyle(fontSize: 11, color: Colors.black54)),
                const SizedBox(height: 6),
